...
const CHECKLIST_ITEMS: ChecklistItem[] = [
  ...
  // ── 카테고리 5: Legal Documents ──────────────────────────────────────
  {
    ...
    item_order: 1,
    title_ko: "이용약관",
    title_en: "Terms of Service (Approved)",
    description_ko: "승인 완료된 공식 이용약관. 플랫폼 책임 한계, 분쟁 조항, 준거법 포함.",
    description_en: "Approved official Terms of Service. Includes liability limitations, dispute clause, and governing law.",
    priority: "P0",
    needs_value: false,
    value_label: null,
    value_is_secret: false,
  },
  {
    ...
    description_ko: "미국 오픈용 개인정보처리방침. PIPA, Virginia CDPA, CCPA/CPRA, 국외 이전, 보유 기간, 사용자 권리를 명시합니다.",
    description_en: "U.S. launch Privacy Policy. Covers PIPA, Virginia CDPA, CCPA/CPRA, international transfers, retention, and user rights.",
    priority: "P0",
    needs_value: false,
    value_label: null,
    value_is_secret: false,
  ...
  },
  {
    ...
    description_ko: "기관 고객 또는 데이터 보호 요청 고객과 체결하는 데이터 처리 계약 템플릿. PIPA, CDPA, GDPR 의무 준수용.",
    description_en: "Data Processing Agreement template for organizational clients and data protection requests. Covers PIPA, CDPA, and GDPR obligations.",
    priority: "P0",
    needs_value: false,
    value_label: null,
    value_is_secret: false,
