      ...
      >
        ...
        >
          ...
          >
              ...
              <ol>
                <li>
                  ...
                  <ul style={{ marginTop: "8px" }}>
                    ...
                    <li>화상 플랫폼(LiveKit Cloud) 서비스 장애 — 단, 개인 네트워크 문제는 제외</li>
            ...
            <Section title="5. 환불 신청 방법 및 처리 기간">
              <ol>
                ...
                <li>
                  ...
                  <ul style={{ marginTop: "8px" }}>
                    <li>카드 결제(Stripe): Stripe 환불 처리 → 카드사 영업일 기준 5~10일 소요</li>
                  </ul>
                </li>
              </ol>
            </Section>
            ...
            {/* 6. 해외 카드 결제 환불 */}
            <Section title="6. 해외 카드 결제 환불 안내">
              <ol>
                <li>해외 발행 카드를 통한 결제 환불은 Stripe 및 발행사 정책에 따라 처리되며, 환율 변동으로 인한 차액은 회사가 책임지지 않습니다.</li>
                <li>환불은 결제 통화(KRW) 기준으로 처리되며, 카드사 환산 환율이 결제 시점과 환불 시점이 달라 차액이 발생할 수 있습니다.</li>
                <li>카드 발행사 문제로 인한 환불 지연은 이용자 본인이 카드사에 직접 문의해야 하며, 회사는 이에 대한 책임을 부담하지 않습니다.</li>
                <li>해외 카드 수수료(있는 경우)는 카드사 정책에 따라 이용자 부담으로 적용될 수 있습니다.</li>
              </ol>
            </Section>
