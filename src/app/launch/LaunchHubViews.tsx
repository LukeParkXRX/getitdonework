...
const PAGE_GROUPS = [
  { role: "Public", icon: "🌐", pages: [
    ...
    { path: "/acceptable-use", ko: "허용 이용 정책", en: "Acceptable use policy" },
    { path: "/cookie-policy", ko: "쿠키 정책", en: "Cookie policy" },
    { path: "/dpa", ko: "데이터 처리 계약", en: "Data processing agreement" },
